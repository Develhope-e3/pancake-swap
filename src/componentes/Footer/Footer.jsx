      ...
      <div className="parte-abajo-footer">
        ...
        <div>
          ...
          <div>
            ...
            svg={<svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="25px" width="25px" xmlns="http://www.w3.org/2000/svg"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0"></path><path d="M3.6 9h16.8"></path><path d="M3.6 15h16.8"></path><path d="M11.5 3a17 17 0 0 0 0 18"></path><path d="M12.5 3a17 17 0 0 1 0 18"></path></svg>}
            />
          </div>
        </div>
        <div className="parte-abajo-derecha">
          ...
          <Link
            ...
            url={"https://discord.com/invite/pancakeswap"}
            svg={<svg viewBox="0 0 198 199" color="text" width="16px" xmlns="http://www.w3.org/2000/svg">
            <path
